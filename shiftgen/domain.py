...
class Staff:
    ...
    allowed_kinds: tuple[str, ...] | None = None  # None => all kinds allowed


@dataclass(frozen=True)
class Requirements:
    saturday_max_per_person: int = 3
    prefer_max_headcount: bool = True
...
class Assignment:
    day: date
    slots: Mapping[str, str]  # slot_name -> staff_id (missing => unused/unassigned)
